...
class Excel_XML
{
        ...
        private function generateWorksheet($item)
        {
                ...
                if (count($item['data']))
/* SITS */				$item['data'] = array_slice($item['data'], 0, 1048576 /*65536*/ );
        ...
        private function generateCell($item)
        {
                ...
                if (is_numeric($item)):
                        $type = 'Number';
/* SITS */              if ($item[0] == '0' && strlen($item) > 1 && $item[1] != '.'):   // PHP 7.4 => Deprecated: Array and string offset access syntax with curly braces is deprecated in .../components/com_jdbexport/helpers/PHPExcelAlternative/php-excel.alternative.class.php on line 255
                                $type = 'String';
                        endif;
                endif;
