    ...
    <div class="row">
        <div class="col-md-4">
            <div class="mb-3">
                ...
                ?>
                    <option <?=$option['id']==$product['id_category'] ? "selected" : "" ?> value="<?=$option['id']?>">
        ...
        <div class="col-md-8">
            <div class="mb-3">
                ...
                <input type="text" value="<?=$product['nama_barang']?>" class="form-control" id="nama_barang"
                    name="nama_barang">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-4">
            <div class="mb-3">
                ...
                <input type="text" value="<?='Rp.'.number_format($product['harga_beli'],0,',','.')?>"
                    class="form-control" id="harga_beli" name="harga_beli">
            </div>
        </div>
        <div class="col-md-4">
            <div class="mb-3">
                <label for="harga_jual" class="form-label">Harga Jual</label>
                <input type="text" value="<?='Rp.'.number_format($product['harga_jual'],0,',','.')?>"
                    class="form-control" id="harga_jual" name="harga_jual">
            </div>
        </div>
        <div class="col-md-4">
            <div class="mb-3">
                <label for="stok_barang" class="form-label">Stok Barang</label>
                <input type="text" value="<?=$product['stok']?>" class="form-control" id="stok_barang"
                    name="stok_barang">
            </div>
        </div>
    </div>
...
function previewImageEdit(event) {
    ...
    imagePreview.innerHTML = '<img src="<?=site_url().$product['image']?>" alt="Preview">';
...
$(document).on('submit', "#FormInput", function(e) {
    ...
    $.ajax({
        url: "<?= site_url('/product/edit/'.$product['id']) ?>",
        type: "post",
